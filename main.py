...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:1881rk@localhost/hms'
db=SQLAlchemy(app)
...
def patients():
    ...
    if request.method=="POST":
        ...
        # mail.send_message(subject,sender=params['gmail-user'],recepients=[email],body = "Your booking is confirmed. Thanks for choosing us.")
